...
Здесь сравнивается возвращенное значение strlen и на этом основании выбирается следующий переход, который явялется проверкой совпадает введенный ключ с тем, что сгенерирован \
