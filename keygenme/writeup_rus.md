...
Сгенерированные MD5-хэши действительно записались в буферы. А блок со смещениями, о котором мы говорили ранее, это строка, в которую добавляются символы из 
